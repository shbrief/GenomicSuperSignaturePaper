...
length(unique(most_similar_ind)) # 2,123 unique RAVs from RAVmodel_20 is matched
```
...
Jaccard index and saved it under `Jaccard_studies` column of the `summary_tbl` table.
