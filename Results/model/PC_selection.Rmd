...
cg <- readRDS("~/data2/model_building/data/topGenes_13934.rds")
...
```{r echo=FALSE}
pcNumAll <- read.table("~/data2/GenomicSuperSignaturePaper/Revisions/pcNumAll.tsv", 
                       header = TRUE)
...
# RAVmodel from 10 PCs
```{r}
refinebioRseq_PCAmodel_c2 <- readRDS("~/data2/GenomicSuperSignatureLibrary/refinebioRseq/PCAmodel_536_10PCs/refinebioRseq_PCAmodel_c2.rds")
