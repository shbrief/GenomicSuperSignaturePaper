...
proposed a continuous scoring system (PCSS) based on an analysis of 8 colorectal
cancer microarray datasets comprising 1,867 samples, and found it was more 
closely correlated to microsatellite instability (MSI), grade, stage, and tumor 
location. Below is the table of top 4 PCSSs.
