...
This is the table of top 4 average loadings (= PCSS, PC Cluster Subtype Scores) built 
in the [CRC paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-018-1511-4).
...
We identified RAV1575 and RAV834 as the most similar RAVs to PCSS1 and PCSS2, respectively,
...
Using `annotateRAV` function, we checked the MSigDB C2 genesets that are enriched
in RAV1575 and RAV834.
