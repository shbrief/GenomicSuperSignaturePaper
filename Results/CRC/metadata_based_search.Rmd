...
names(f.stat.all) <- paste0("RAV", seq_len(ncol(PCAmodel)))
...
names(normality) <- paste0("RAV", seq_len(ncol(PCAmodel)))
summary(normality)
```
...
names(kw.chi.sqr) <- paste0("RAV", seq_len(ncol(PCAmodel)))
...
names(msi.t.test) <- paste0("RAV", seq_len(ncol(PCAmodel)))
...
names(location.t.test) <- paste0("RAV", seq_len(ncol(PCAmodel)))
...
names(grade.t.test) <- paste0("RAV", seq_len(ncol(PCAmodel)))
...
names(stage.t.test) <- paste0("RAV", seq_len(ncol(PCAmodel)))
