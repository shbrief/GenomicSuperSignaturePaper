...
using PCAGenomicSignatures and referencing some script from [this vignette](https://github.com/greenelab/multi-plier/blob/master/figure_notebooks/neutrophil_figures.Rmd).
