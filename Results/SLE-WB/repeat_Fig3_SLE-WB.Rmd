...
plot_n.count <- LVScatter(dat_n.count, paste0("PCcluster", 1551), 
                          y.var = "Neutrophil.Count",
                          ylab = "Neutrophil Count")
plot_n.estimate <- LVScatter(dat_n.estimate, paste0("PCcluster", 1551), 
                             y.var = "Neutrophil_estimate",
                             ylab = "MCPcounter Neutrophil Estimate")

plots <- list(plot_n.count, plot_n.estimate)
saveRDS(plots, "sle_neutrophil.rds")
```
