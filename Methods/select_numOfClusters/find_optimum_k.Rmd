...
```{r echo=FALSE, eval=TRUE, fig.width=6, fig.height=5.5}
...
This plot shows the proportion of the negative controls that are separated under
different numbers of clusters. For all five different numbers of negative controls, 
more than 90% of them were separated when **d = 4** and 100% of them were separated 
when **d = 2.25**.
...
This plot shows the actual number of negative controls that weren't separated under
