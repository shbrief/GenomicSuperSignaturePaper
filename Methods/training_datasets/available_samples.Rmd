...
in `GenomicSuperSignature` package. 
...
## Availability based on metadata
...
## Availability based on download/import
...
## Imported samples
1399 studies > 20 samples were successfully imported by `tximport::tximport` 
```{r echo=FALSE}
...
# Training datasets: multiPLIER vs. RAVmodel
